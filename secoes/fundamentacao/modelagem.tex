Sistemas baseados em agentes podem ser modelados utilizando-se técnicas de engenharia de software que, assim como a abordagem orientada a objetos, se constitui em uma outra abordagem denominada modelagem orientada a agentes, que aborda um nível mais alto de abstração que este, buscando identificar as nuances envolvidas com os papéis dos agentes, seus objetivos individuais e coletivos e suas interações mútuas. Várias abordagens de Engenharia de Software Orientada a Agentes \abreviatura{AOSE}{Agent Oriented Software Engineering}(AOSE na sigla em inglês) são encontradas na literatura. Algumas inspirados na orientação a objetos e outras bastante diversa \cite{intelligent}. Em consequência disso, métodos relacionados ao desenvolvimento de aplicativos orientados a objeto formam a base de boa parte dos métodos de desenvolvimento de sistemas baseados em agentes. De forma similar a técnica para modelagem orientada a objeto proposta por \citeonline{OMT} que consiste de modelo básico, modelo estático e modelo dinâmico, \citeonline{agent-oriented} divide a análise orientada a agentes em três modelos, o modelo de agente, o modelo organizacional e o modelo cooperativo, descritos a seguir:
