...
\end{enumerate}
LUCAS, VEJA ESTES NOMES E TROQUE SUA MODELAGEM PARA ELES, OU TROQUE AQUI PARA O NOME QUE VOCÊ PREFERIR %TODO: LUCAS!!! <---- LEIA
...
\begin{itemize}
	...
	\item Um gerente de alocação encarregado de tomar decisões realativas a alocação de novas VMs como onde alocá-las e a de ou não de ativar recursos desligados;
