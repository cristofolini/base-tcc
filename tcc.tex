...
\coorientador[Coorientador\\Universidade Federal de Santa Catarina]{Me. Rafael Weing\"artner}
\coordenador[Coordenador do Curso\\Universidade Federal de Santa Catarina]{Prof. Dr. M\'{a}rio Ant\^{o}nio Ribeiro Dantas}
...
\bancaMembroA{Prof. Dr. Mário Antônio Ribeiro Dantas\\Universidade Federal de Santa Catarina} %Nome do presidente da banca
\bancaMembroB{Prof. Dr. Élder Rizzon Santos\\Universidade Federal de Santa Catarina}      % Nome do membro da Banca
...
\input{secoes/desenvolvimento/desenvolvimento.tex}
